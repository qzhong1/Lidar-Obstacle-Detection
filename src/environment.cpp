...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
  ...
  // ----------------------------------------------------
    ...
    pcl::PointCloud<pcl::PointXYZI>::Ptr filterCloud = pointProcessorI->FilterCloud(inputCloud, 0.1, Eigen::Vector4f (-10, -10, -10, -15), Eigen::Vector4f (10, 10, 10, 15));
    ...
    std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessorI->Clustering(segmentCloud.first, 0.5, 100, 1000);
